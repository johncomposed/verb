...
const EXAMPLES = [
  ...
  { name: 'surfaceConformFit', label: 'Surface Conform to Sphere — LSQ Fit', r3fOnly: true },
  { name: 'surfaceConformIter', label: 'Surface Conform to Sphere — Iterative', r3fOnly: true },
  { name: 'surfaceConformTrim', label: 'Surface Conform to Sphere — Trim + Patch', r3fOnly: true },
